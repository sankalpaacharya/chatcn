      ...
      <CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-muted-foreground/90 text-md">
            The Login/Signup component is a sleek, user-friendly form designed for seamless user authentication. It includes fields for full name, email, password, and password confirmation, with built-in validation for minimum lengths and a clean, modern design. Perfect for adding secure user registration to your web application.
          </p>
        </CardContent>
      </Card>
