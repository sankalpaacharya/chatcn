...
- **Folder Display** - Display folders with customizable click handlers
- **File Display** - Show files with automatic icon detection based on extension
- **Thumbnail Support** - Display image and video thumbnails
- **Keyboard Navigation** - Built-in tab index support for accessibility
