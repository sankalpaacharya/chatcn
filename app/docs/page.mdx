...
If you spot something off, have an idea, or just wanna say hi — you can [open an issue on GitHub](https://github.com/sankalpaacharya/shadcn-collections) or reach out directly.
