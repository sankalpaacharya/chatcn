"use client"
import { Message, MessageAvatar, MessageContent, MessageActions, MessageAction } from "@/components/chatcn/ai/message"
import {
	PromptInput,
	PromptInputTextArea,
	PromptInputActions,
...
import { Thought, ThoughtTrigger, ThoughtContent } from "@/components/chatcn/ai/thought"
import { Thread, ThreadContent, ThreadActions, ThreadAction } from "@/components/chatcn/ai/thread"
			...
			<div className="rounded-2xl border overflow-hidden">
				...
				<div className="flex items-center gap-3 px-4 py-3 border-b">
					...
					<div className="flex-1 flex justify-center">
						<span className="text-sm text-muted-foreground font-medium">Chatcn — AI Interface Components</span>
					</div>
					...
					<div className="w-64 border-r flex-shrink-0 hidden lg:flex flex-col">
						...
						<div className="flex-1 p-2 space-y-1 overflow-y-auto">
							<Thread>
								...
								<ThreadActions>
									<ThreadAction><Pin className="w-4 h-4" /> Pin</ThreadAction>
									<ThreadAction><Archive className="w-4 h-4" /> Archive</ThreadAction>
									<ThreadAction><Trash2 className="w-4 h-4" /> Delete</ThreadAction>
								</ThreadActions>
							</Thread>
							<Thread>
								<ThreadContent>
					...
					<div className="flex-1 flex flex-col">
						...
						<div className="flex-1 p-6 space-y-6 overflow-y-auto">
							...
							<Thought>
								...
								<ThoughtContent>
									I&apos;m analyzing the best practices for creating AI chat interfaces. This includes considering component structure, state management, and UI/UX patterns commonly used in modern chat applications.
								</ThoughtContent>
							</Thought>
							...
							<Tool
								...
								output={{ results: 12, topMatch: "shadcn/ui components", confidence: 0.94 }}
							/>
