...
export default function Navbar({ sidebar }: { sidebar?: React.ReactNode }) {
          ...
          <div className="flex flex-1 items-center justify-between">
            ...
            <div className="flex items-center gap-2 ml-auto">
              ...
              >
                ...
                <Kbd className="pointer-events-none absolute right-1.5 top-1/2 -translate-y-1/2 hidden lg:inline-flex">
                  ⌘K
                </Kbd>
              </Button>
